...
<!-- banner -->
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="petugas_data_kelurahan_tambah.php">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><center><?php echo $data['jumlah_rw']; ?> RT</center></td>
									<td><center><?php echo $data['jumlah_rt']; ?> RW</center></td>
									<td><center><?php echo $data['ordinat_x']; ?> X</center></td>
									<td><center><?php echo $data['ordinat_y']; ?> Y</center></td>
									<td>
										<center>
											<a href="petugas_data_kelurahan_ubah.php?ubah=<?php echo $data['kd_kel']; ?>">
												<img src="images/edit-property-xxl.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="petugas_data_kelurahan_hapus.php?hapus=<?php echo $data['kd_kel']; ?>" onclick="return doconfirm()">
