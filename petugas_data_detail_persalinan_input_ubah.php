<?php
	...
	$kd_det_persalinan=$_POST['kd_det_persalinan'];
	...
	
	{
		...
		include("petugas_data_detail_persalinan_kueri_update.php");
		
		if($query){
			header('location:petugas_data_detail_persalinan_form.php?kd='.$kd_persalinan.'&success_ubah=1');
		}
		else{
			die(mysql_error());
		}
