...
<!-- banner -->
	...
	<div class="contact">
		<div class="container">
			<div class="contact-form">
				...
				?>
					<h3 style="margin-bottom:0px;">Halaman Data Pelayanan Ibu Nifas</h3>
					<div class="alerts">
				...
				?>
					<h3>Halaman Data Pelayanan Ibu Nifas</h3>
				<?php
					}
				?>
			</div>
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="petugas_data_ibu_nifas_tambah.php">
			...
			<div class="panel-body">
				<div class="dataTable_wrapper">
					<?php 
						...
						$query = mysql_query("select * from pelayanan_ibu_nifas");
					?>
					<table style="font-size:12px;" class="table table-striped table-bordered table-hover" id="dataTables-example">
						<thead>
							<tr>
								...
								<th><center>Cara KB/Kontrasepsi</center></th>
								<th>Opsi</th>
							</tr>
						</thead>
						<tbody>
							...
							?>
								<tr>
									...
									<td><center><?php echo $data['tempat']; ?></center></td>
									<td><center><?php echo $data['cara_kb_kontrasepsi']; ?></center></td>
									<td>
										<center>
											<a href="petugas_data_detail_ibu_nifas_form.php?kd=<?php echo $data['kd_pelayanan']; ?>">
												<img src="images/med-record.png" style="margin-left:10px; margin-bottom:5px;" width="30" height="30"/>
											</a>
											
											<a href="petugas_data_ibu_nifas_ubah.php?ubah=<?php echo $data['kd_pelayanan']; ?>">
												<img src="images/edit-property-xxl.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="petugas_data_ibu_nifas_hapus.php?hapus=<?php echo $data['kd_pelayanan']; ?>" onclick="return doconfirm()">
