...
<!-- banner -->
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="bidan_data_detail_ibu_nifas_ubah.php?kd=<?php echo $kd; ?>">
					<img src = "images/add-list-xxl.png" width="80px" height="80px">
				</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="bidan_data_detail_ibu_nifas_hapus.php?kd=<?php echo $kd; ?>&hapus=<?php echo $kd_det_ibu_nifas; ?>" onclick="return doconfirm()">
					<img src="images/delete-xxl.png" width="80px" height="80px"/>
				</a>
