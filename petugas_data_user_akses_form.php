...
<!-- banner -->
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="petugas_data_user_akses_tambah.php?bagian=<?php echo $bagian; ?>">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<center>
											<a href="petugas_data_user_akses_ubah.php?ubah=<?php echo $data['kd_user']; ?>">
												<img src="images/edit-property-xxl.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="petugas_data_user_akses_hapus.php?bagian=<?php echo $data['bagian'];?>&hapus=<?php echo $data['kd_user']; ?>" onclick="return doconfirm()">
