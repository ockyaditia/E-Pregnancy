...
<!-- banner -->
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="petugas_data_ibu_hamil_tambah.php">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<center>
											<a href="petugas_data_ibu_hamil_ubah.php?ubah=<?php echo $data['kd_header']; ?>">
												<img src="images/edit-property-xxl.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="petugas_data_ibu_hamil_hapus.php?hapus=<?php echo $data['kd_header']; ?>" onclick="return doconfirm()">
