<?php
	...
	{
		include("bidan_data_detail_ibu_nifas_kueri_insert.php");
		
		if($query){
			header('location:bidan_data_detail_ibu_nifas_form.php?kd='.$kd_pelayanan.'&success=1');
		}
		else{
			die(mysql_error());
		}
	...
	{
		include("bidan_data_detail_ibu_nifas_kueri_update.php");
		
		if($query){
			header('location:bidan_data_detail_ibu_nifas_form.php?kd='.$kd_pelayanan.'&success_ubah=1');
		}
		else{
			die(mysql_error());
		}
