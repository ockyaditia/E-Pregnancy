	...
	<div class="banner-bottom">
		<div class="container2">
			<div class="banner-bottom-grid-right-grid2">
				...
				<form action="petugas_data_ibu_nifas_input_ubah.php" method="post">
					...
					<input type="text" name="kd_data_kehamilan" id="kd_data_kehamilan" placeholder="Kode Kehamilan" required value="<?php echo $kd_data_kehamilan; ?>" style="background:#FFFFFF; color:#6ECDCF" class="readonly" >
					...
					<input type="text" name="tempat" placeholder="Tempat" value="<?php echo $tempat; ?>" required >
					
					<span style="color:#FFFFFF">Cara KB / Kontrasepsi<span style="color:#FF0000">&nbsp;*</span></span>
					<input type="text" name="cara_kb_kontrasepsi" placeholder="Cara KB / Kontrasepsi" value="<?php echo $cara_kb_kontrasepsi; ?>" required >
