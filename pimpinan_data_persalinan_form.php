						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<center>
											<a href="pimpinan_data_detail_persalinan_form.php?kd=<?php echo $data['kd_persalinan']; ?>">
												<img src="images/med-record.png" style="margin-left:10px; margin-bottom:5px;" width="30" height="30"/>
											</a>
											
											<a href="pimpinan_data_persalinan_lihat.php?lihat=<?php echo $data['kd_persalinan']; ?>">
