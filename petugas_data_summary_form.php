...
<!-- banner -->
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="petugas_data_summary_tambah.php">
								...
								<tr>
									...
									<td>
										<center>
											...
											<a href="petugas_data_summary_ubah.php?ubah=<?php echo $data['kd_summary']; ?>">
												<img src="images/edit-property-xxl.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="petugas_data_summary_hapus.php?hapus=<?php echo $data['kd_summary']; ?>" onclick="return doconfirm()">
