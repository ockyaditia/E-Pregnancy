						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<center>
											<a href="petugas_data_umpan_balik_rujukan_lihat.php?lihat=<?php echo $data['kd_umpan_balik_rujukan']; ?>">
												<img src="images/view-details-xxl.png" style="margin-left:10px; margin-bottom:5px;" width="30" height="30"/>
											</a>
											
											<a href="petugas_data_umpan_balik_rujukan_hapus.php?hapus=<?php echo $data['kd_umpan_balik_rujukan']; ?>" onclick="return doconfirm()">
