...
<!-- banner -->
	...
	<div class="container" style="margin-top:-75px;">
		<div class="panel panel-default">
			...
			<center>
				<a href ="petugas_data_medrec_kehamilan_tambah.php?kd=<?php echo $kd; ?>">
					<img src = "images/add-list-xxl.png" width="80px" height="80px">
				</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href ="petugas_data_medrec_kehamilan_lihat.php?kd=<?php echo $kd; ?>">
					<img src = "images/view-details-xxl.png" width="80px" height="80px">
				</a>
			</center>
								...
								<tr>
									...
									<td>
										<center>
											...
											<a href="petugas_data_medrec_kehamilan_ubah.php?kd=<?php echo $data['kd_data_kehamilan']; ?>&ubah=<?php echo $data['kd_med_rec_kehamilan']; ?>">
												<img src="images/edit-property-xxl.png" style="margin-left:10px; margin-bottom:5px;" width="30" height="30"/>
											</a>
										
											<a href="petugas_data_medrec_kehamilan_hapus.php?kd=<?php echo $data['kd_data_kehamilan']; ?>&hapus=<?php echo $data['kd_med_rec_kehamilan']; ?>" onclick="return doconfirm()">
